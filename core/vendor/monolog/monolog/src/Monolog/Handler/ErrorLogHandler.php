...
class ErrorLogHandler extends AbstractProcessingHandler {
     ...
     */
    public function __construct(int $messageType = self::OPEodds_type, $level = Logger::DEBUG, bool $bubble = true, bool $expandNewlines = false) {
